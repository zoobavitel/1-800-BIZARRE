...
export const PATCH_NOTES = [
  {
    ...
    sections: [
      ...
      {
        title: "Added",
        items: ["per-section SRD pages, split script, and rules nav layout"],
      },
      {
        title: "Maintenance",
        items: ["remove monolithic game-rules-srd.md"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: "Fixed",
        items: ["DELETE 204 empty body; Home delete shows errors"],
      },
      {
        title: "Documentation",
        items: [
  ...
  },
  {
    ...
    sections: [
      {
        title: "Other",
        items: ["Update character management features and enhance logging"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: "Maintenance",
        items: ["Add new log entry for file change monitoring"],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      {
        title: "Fixed",
        items: ["Update homepage URL and modify deploy script in package.json"],
      },
      {
        title: "Other",
        items: ["update"],
  ...
  },
  {
    ...
    sections: [
      {
        title: "Maintenance",
        items: ["Update package dependencies and remove unused files"],
      },
      {
        title: "Added",
        items: [
  ...
  },
  {
    ...
    sections: [
      {
        title: "Other",
        items: ["Implement session and faction management models"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      {
        title: "Other",
        items: ["Deleted over engineered character creation page."],
      },
    ],
  },
  {
